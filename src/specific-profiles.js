...
let profiles = [];
const teams = [/*TEAM IDS GO HERE (e.g. 1, 123, 1234*/]
teams.forEach(function (value) {
   let profile = "https://fantasy.premierleague.com/drf/entry/"+value;
...
setInterval(function() {
  ...
  fpl.profiles(currentProfile, (data) => {
    ...
    let profile= {
      ...
      summary_event_points: data.entry.summary_event_points,
